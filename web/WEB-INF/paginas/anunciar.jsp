<%@page import="br.com.grupointegrado.dao.AnuncioDao"%>
...
<head>
    ...
    <script>
        ...
        var ano = document.getElementById(anoFabricacao);
        var modelo = document.getElementById(anoModelo);
        var KM = document.getElementById(quilometragem);
                ...
                <div class="form-row">
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                        <div class="form-group">
                            ...
                            <input type="number" step="1" class="form-control" id="anoFabricacao" placeholder="2016">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                        <div class="form-group">
                            ...
                            <input type="number" step="1" class="form-control" id="anoModelo" placeholder="2017">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="1" class="form-control" id="valor" placeholder="119990">
                                <div class="input-group-append">
                ...
                <div class="form-row">
                    <div class="col-lg-8 col-xl-7">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="descricao" placeholder="Carro em ótimas condições..."></textarea>
                            <div class="invalid-feedback">
